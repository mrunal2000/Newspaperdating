          ...
          {profile.interests.map((interest, index) => (
            <Badge key={index} variant="outline" className="text-xs font-nyt">
              {interest}
                  ...
                  {/* Social Media Fields */}
          {(profile.instagram || profile.twitter || profile.discord || profile.phoneNumber) && (
            <div className="flex flex-col gap-2 mt-2 items-center">
              {profile.instagram && (
                <div className="flex items-center gap-2 justify-center">
                  <svg className="w-3 h-3 text-[#212121]" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <span className="text-[14px] font-nyt text-[#212121]">{profile.instagram}</span>
                </div>
              )}
              {profile.twitter && (
                <div className="flex items-center gap-2 justify-center">
                  ...
                  <span className="text-[14px] font-nyt text-[#212121]">{profile.twitter}</span>
                </div>
              )}
              {profile.discord && (
                <div className="flex items-center gap-2 justify-center">
                  <svg className="w-3 h-3 text-[#212121]" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1277 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0027-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419-.019 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1568 2.4189Z"/>
                  </svg>
                  <span className="text-[14px] font-nyt text-[#212121]">{profile.discord}</span>
                </div>
              )}
              {profile.phoneNumber && (
                <div className="flex items-center gap-2 justify-center">
                  ...
                  <span className="text-[14px] font-nyt text-[#212121]">{profile.phoneNumber}</span>
                </div>
              )}
            </div>
          )}
...
function AddPostForm({ onAddPost, isOpen, setIsOpen, currentCity }: { onAddPost: (profile: Omit<Profile, 'id' | 'createdAt'>) => void; isOpen: boolean; setIsOpen: (open: boolean) => void; currentCity: string }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.name && formData.age && formData.title && formData.description) {
      ...
      // Debug logging
      console.log('🔍 Form submitted with social media:', { instagram: formData.instagram, twitter: formData.twitter, discord: formData.discord, phoneNumber: formData.phoneNumber });
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl bg-white border-2 border-black shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              <label className="block font-nyt text-sm font-medium mb-1">Instagram Handle (optional)</label>
              <input
                type="text"
                value={formData.instagram}
                onChange={(e) => {
                  console.log('🔍 Instagram handle changed to:', e.target.value);
              ...
              <div className="text-xs text-gray-500 mt-1">
                Current value: "{formData.instagram}"
              </div>
            </div>
            
            <div>
              <label className="block font-nyt text-sm font-medium mb-1">Twitter Handle (optional)</label>
              <input
                type="text"
                value={formData.twitter}
                onChange={(e) => {
                  console.log('🔍 Twitter handle changed to:', e.target.value);
              ...
              />
              <div className="text-xs text-gray-500 mt-1">
                Current value: "{formData.twitter}"
              </div>
            </div>
            
            <div>
              <label className="block font-nyt text-sm font-medium mb-1">Discord Handle (optional)</label>
              <input
                type="text"
                value={formData.discord}
                onChange={(e) => {
                  console.log('🔍 Discord handle changed to:', e.target.value);
              ...
              />
              <div className="text-xs text-gray-500 mt-1">
                Current value: "{formData.discord}"
              </div>
            </div>
            
            <div>
              <label className="block font-nyt text-sm font-medium mb-1">Phone Number (optional)</label>
              <input
                type="text"
              ...
              />
              <div className="text-xs text-gray-500 mt-1">
                Current value: "{formData.phoneNumber}"
              </div>
            </div>
            ...
            <div className="flex justify-end pt-4 gap-2">
              <Button
                ...
                variant="newspaper"
                onClick={() => {
                  console.log('🔍 Manual test - form data:', formData);
                  console.log('🔍 Manual test - social media:', { instagram: formData.instagram, twitter: formData.twitter, discord: formData.discord, phoneNumber: formData.phoneNumber });
                }}
